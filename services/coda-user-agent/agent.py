...
AGENT_MAX_FEE = os.getenv("AGENT_MAX_FEE", random.randint(1, 20))
AGENT_MAX_TX = os.getenv("AGENT_MAX_TX", random.randint(1,100))
...
class Agent(object):
    ...
    def send_transaction(self):
        ...
        tx_amount = random.randint(1, self.max_tx_amount) * 1000000000
        fee_amount = random.randint(1, self.max_fee_amount) * 1000000000
        try: 
