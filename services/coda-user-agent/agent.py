...
AGENT_MIN_FEE = os.getenv("AGENT_MIN_FEE", Currency.random(Currency("0.06"), Currency("0.1")))
AGENT_MIN_FEE = os.getenv("AGENT_MAX_FEE", Currency.random(AGENT_MIN_FEE, AGENT_MIN_FEE + Currency("0.2")))
AGENT_MIN_TX = os.getenv("AGENT_MIN_TX", Currency.random(Currency("0.0015"), Currency("0.005")))
AGENT_MAX_TX = os.getenv("AGENT_MAX_TX", Currency.random(AGENT_MIN_TX, AGENT_MIN_TX + Currency("0.01")))
