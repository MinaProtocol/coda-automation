...
module "testnet_east" {
  ...
  coda_image            = "codaprotocol/coda-daemon:0.0.12-beta-feature-tokens-cli-d2a9185"
  ...
  snark_worker_public_key = "B62qq4HxbYHSoEZBtZPKmVVU2CMPy7KjM79P2txcoukTQRqBcTivKaX"
