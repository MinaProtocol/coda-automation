terraform {
  ...
  backend "s3" {
    key     = "terraform-big-qa-net.tfstate"
    encrypt = true
    region  = "us-west-2"
...
locals {
  ...
  coda_image = "gcr.io/o1labs-192920/coda-daemon-baked:0.2.5-d44a133-d44a133-big-qa-net-40d47f8"
  coda_archive_image = "gcr.io/o1labs-192920/coda-archive:0.2.5-d44a133"
