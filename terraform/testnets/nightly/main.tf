...
locals {
  ...
  coda_image = "gcr.io/o1labs-192920/coda-daemon:0.0.17-beta6-develop-4cea147"
  coda_archive_image = "gcr.io/o1labs-192920/coda-archive:0.0.17-beta6-develop-4cea147"
...
module "testnet_east" {
  ...
  block_producer_starting_host_port = 10201
