terraform {
  ...
  backend "s3" {
    key     = "terraform-snark-pool-test.tfstate"
    encrypt = true
    region  = "us-west-2"
...
locals {
  testnet_name = "snark-pool-test"
  coda_image = "codaprotocol/coda-daemon:0.0.16-beta7-fix-snark-pool-errors-1b7a89d"
  coda_archive_image = "codaprotocol/coda-archive:0.0.16-beta7-develop-24ff219"
